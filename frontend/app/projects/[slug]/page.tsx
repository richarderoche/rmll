...
export async function generateMetadata(
  ...
  const ogImage = urlForOpenGraphImage((project?.ogImage ?? project?.coverImage) as Image)
...
export default async function ProjectSlugRoute(props: PageProps<'/projects/[slug]'>) {
  const params = await props.params
